 ...
 *       &lt;sequence&gt;
 *         &lt;element name="return" type="{http://ws.soapserver.isdcm}videoDTO" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class VideoResponse {
    ...
    protected List<VideoDTO> _return;
    ...
    public List<VideoDTO> getReturn() {
        if (_return == null) {
            _return = new ArrayList<VideoDTO>();
        }
        return this._return;
    }
